...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void setDepartamentService(DepartmentServive service) {
	...
	private void initializeNodes() {
		...
		tableViewDepartment.prefHeightProperty().bind(stege.heightProperty());
	...
	private void createDialogForm(Departament obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.setDepatmentServive(new DepartmentServive());
